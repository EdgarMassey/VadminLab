...
Public Class VistsF
    ...
    Private Sub VistsF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim rect As Rectangle = Screen.PrimaryScreen.WorkingArea
        Me.Top = (rect.Height / 2) - (Me.Height / 2)
        Me.Left = (rect.Width / 2) - (Me.Width / 2)

        Ver.Text = "Version: " + vernr
        Huvud.Text = Prognamn + " - BesökRegister "
        datum.Text = today
    ...
    Private Sub RaderaB_Click(sender As Object, e As EventArgs) Handles RaderaB.Click
        ...
        Dim response
        response = MsgBox("Vill du verkligen radera besöket", 1, "OBS")
